...
export async function waitForUrl(driver, url, timeout = DEFAULT_TIMEOUT) {
...
export async function waitForUrlContains(driver, urlPart, timeout = DEFAULT_TIMEOUT) {
...
export async function clearBrowserData(driver) {
...
export const isElementPresent = async (driver, selector) => {
    try {
...
export async function waitForElementAndClick(driver, selector, timeout = DEFAULT_TIMEOUT) {
...
export async function waitForElementAndType(driver, selector, text, timeout = DEFAULT_TIMEOUT) {
    const element = await waitForElement(driver, selector, timeout);
    try {

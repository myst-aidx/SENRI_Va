...
// AIを使用して運勢を生成
async function generateFortuneUpdate(reading, period) {
...
// 運勢の更新が必要かチェック
function needsUpdate(lastUpdate, period) {
    const now = new Date();
...
// 運勢を更新
export async function updateFortune(reading, period, lastUpdate) {
    // 更新が必要かチェック
